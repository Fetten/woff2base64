...
describe('woff2base64', function () {
  describe('Woff2Base64 Class', function () {
    it('exists', function () {
      expect(Woff2Base64Class).to.exists;
    });
    ...
    it('accepts options', function () {
      ...
      expect(fo.opts.banner).to.equal('/* Generated by woff2base64 (https://github.com/fetten/woff2base64) */\n');
    });
    ...
    it('gets the font data uri by string', function () {
      ...
      expect(woffUri).to.equal('data:application/font-woff;charset=utf-8;base64,d29mZiBpcyBhd2Vzb21l');
      expect(woff2Uri).to.equal('data:application/font-woff2;charset=utf-8;base64,d29mZjIgaXMgYXdlc29tZQ==');
    });

    it('gets the font data uri by Buffer', function () {
      const fo = new Woff2Base64Class({}, options);
      const woffUri = fo.getFontDataUri('woff', new Buffer('woff is awesome'));
      const woff2Uri = fo.getFontDataUri('woff2', new Buffer('woff2 is awesome'));
    ...
    it('gets the FontFace css string', function () {
      const fo = new Woff2Base64Class({}, options);
      const woffFontFace = fo.getFontFace('Roboto-Bold.woff', 'woff', {content: 'Hello world'});
      const woff2FontFace = fo.getFontFace('Roboto-Bold.woff2', 'woff2', {content: 'Hello world'});

      expect(woffFontFace).to.equal(['@font-face{', 'font-family:"Roboto";', 'src:url(data:application/font-woff;charset=utf-8;base64,SGVsbG8gd29ybGQ=) format("woff");', 'font-weight:bold;', 'font-style:normal', '}'].join(''));
      expect(woff2FontFace).to.equal(['@font-face{', 'font-family:"Roboto";', 'src:url(data:application/font-woff2;charset=utf-8;base64,SGVsbG8gd29ybGQ=) format("woff2");', 'font-weight:bold;', 'font-style:normal', '}'].join(''));
    });
